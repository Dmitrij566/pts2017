...
echo "Node.JS 6 installed!"

info "Install Grunt"
npm install -g grunt-cli
grunt --gruntfile frontend/grunt/Gruntfile.js rebuild
...
mysql -uroot <<< "CREATE DATABASE yii2_advanced_tests CHARACTER SET utf8 COLLATE utf8_general_ci"
echo "Done!"
